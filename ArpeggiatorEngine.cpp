...
char ArpeggiatorEngine::buttonDown(char buttonIndex)
{
...
char* ArpeggiatorEngine::buttonUp(char buttonIndex)
{
...
char* ArpeggiatorEngine::releaseAll()
{
...
void ArpeggiatorEngine::encoderValueChange(int deltaValue)
{
	if (shiftDown)
	{
...
void ArpeggiatorEngine::updateLedStates(char* ledStates, const char* ledIndices)
{
	for (int i = 0; i < 16; i++)
	{
